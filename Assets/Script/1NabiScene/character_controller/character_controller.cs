...
public class character_controller : MonoBehaviour
{
    ...
    public static string[] char_motion_name = { "wait_vmd", "nod the head_vmd", "read_vmd", "shake hand_vmd", "sigh_vmd", "worry_vmd", "be proud_vmd", "cover one_s ears_vmd", "happy_vmd", "surprise_vmd" , "optimization" };
